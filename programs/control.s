.text
    ...
    addi $r5, $r0, 1             # TEST 1
    beq $r2, $r1, fail1          # 12==11: branch is *NOT* taken
    
    addi $r5, $r0, 2            # TEST 2
    beq $r2, $r3, fail2         # 12==13: branch is *NOT* taken
    
    addi $r5, $r0, 3            # TEST 3
    beq $r2, $r4, eq_equal      # 12==12: branch is taken
...
eq_equal:
    ...
    addi $r5, $r0, 4            # TEST 4
    bgez $r1, bgez_taken    # 1>0: branch is taken
...
bgez_taken:
    addi $r5, $r0, 5            # TEST 5
    addi $r1, $r0, -1
    bgez $r1, fail3             # 1==0: branch is *NOT* taken
    
    addi $r5, $r0, 6            # TEST 6
    addi $r1, $r0, 0
    bgez $r1, bgez_zero         # 0==0: branch is taken
